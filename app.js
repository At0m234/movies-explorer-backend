...
const whitelist = [
  'http://localhost:3000',
  'http://localhost:3001',
  'https://api.movies.students.nomoredomains.icu/',
  'https://movies.students.nomoredomains.icu/',
  'http://api.movies.students.nomoredomains.icu/',
  'http://movies.students.nomoredomains.icu/',
];
